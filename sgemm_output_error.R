...
file = "~/cluster_results/approx_coherence_results/sgemm/base/m5out/output.txt"
baseline_out = read.table(file, sep = "" , header = F , nrows = 100,
                          na.strings ="", stringsAsFactors= F)

file = "~/cluster_results/approx_coherence_results/sgemm/100/m5out/output.txt"
approx_out = read.table(file, sep = "" , header = F , nrows = 100,
                        na.strings ="", stringsAsFactors= F)
