...
l2_read_energy =  0.191362
l2_write_energy = 0.197432
...
process_energy = function(benchmark_name, baseline_data, approx_data, source_name)
{
  ...
  energy_reduction = (1 - approx_cache_energy_total/baseline_cache_energy_total)
  
  mem_energy_reduction = (1 - dram_access_energy_approx/dram_access_energy_base)
  
  
  baseline_total = baseline_cache_energy_total + dram_access_energy_base
  approx_total = approx_cache_energy_total + dram_access_energy_approx
  ...
  cat("Cache Energy Reduction (%): ", 100*energy_reduction, " Portion (%): ", (approx_cache_energy_total/approx_total)*100, "\n")
  cat("DRAM Energy Reduction (%): ", 100*mem_energy_reduction, " Portion (%): ", (dram_access_energy_approx/approx_total)*100, "\n")
  cat("Total Energy Reduction (%): ", 100*total_reduction, "\n")
  cat("\n")
  
  # print(baseline_cache_energy_total)
  # print(dram_access_energy_base)
  # print(dram_access_energy_base/baseline_cache_energy_total)
...
# benchmark = "histo"
path = "~/cluster_results/store_reset_study_MESI"
# path = "~/cluster_results/top_bytes_study"
...
# benchmark_names = c("spmv")
# benchmark_names = c("linear_regression", "histogram", "pca")
...
for (benchmark in benchmark_names)
{
  ...
  # data = process_energy(benchmark, baseline_data, baseline_data, "Base")
  ...
  data = process_energy(benchmark, baseline_data, approx_data, "SR2")
  all_data = rbind(all_data, data)
  ...
  data = process_energy(benchmark, baseline_data, approx_data, "SR4")
  all_data = rbind(all_data, data)
  ...
  data = process_energy(benchmark, baseline_data, approx_data, "SR8")
  all_data = rbind(all_data, data)
  ...
  # approx_data = processFile(file)
  # 
  # data = process_energy(benchmark, baseline_data, approx_data, "All")
  # all_data = rbind(all_data, data)
...
plot
pdf("energy_saved.pdf", width=9, height=4.5)
print(plot)
dev.off()
