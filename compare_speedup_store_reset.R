...
process_seconds = function(benchmark_name, baseline_data, approx_data, source_name)
{
  
  base_sec = baseline_data$sim_seconds
  approx_sec = approx_data$sim_seconds
  
  speedup = (base_sec/approx_sec - 1)*100
...
for (benchmark in benchmark_names)
{
  ...
  # data = process_seconds(benchmark, baseline_data, baseline_data, "Base")
  ...
  data = process_seconds(benchmark, baseline_data, approx_data, "SR2")
  all_data = rbind(all_data, data)
  ...
  data = process_seconds(benchmark, baseline_data, approx_data, "SR4")
  all_data = rbind(all_data, data)
  ...
  data = process_seconds(benchmark, baseline_data, approx_data, "SR8")
  all_data = rbind(all_data, data)
  ...
  # approx_data = processFile(file)
  # 
  # data = process_seconds(benchmark, baseline_data, approx_data, "All")
  # all_data = rbind(all_data, data)
...
plot
pdf("speedup.pdf", width=9, height=4.5)
print(plot)
dev.off()
