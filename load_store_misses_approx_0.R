...
file = "~/cluster_results/results_approx_0/kmeans/m5out/stats.txt"
file_data = processFile(file)
all_benchmarks[nrow(all_benchmarks) + 1,] = file_data

file = "~/cluster_results/results_approx_0/histogram/m5out/stats.txt"
file_data = processFile(file)
all_benchmarks[nrow(all_benchmarks) + 1,] = file_data

file = "~/cluster_results/results_approx_0/pca/m5out/stats.txt"
file_data = processFile(file)
all_benchmarks[nrow(all_benchmarks) + 1,] = file_data

file = "~/cluster_results/results_approx_0/matrix_multiply/m5out/stats.txt"
file_data = processFile(file)
all_benchmarks[nrow(all_benchmarks) + 1,] = file_data
...
# file = "~/cluster_results/results_approx_0/blackscholes/m5out/stats.txt"
# file_data = processFile(file)
# all_benchmarks[nrow(all_benchmarks) + 1,] = file_data
# 
# file = "~/cluster_results/results_approx_0/bodytrack/m5out/stats.txt"
# file_data = processFile(file)
# all_benchmarks[nrow(all_benchmarks) + 1,] = file_data
# 
# file = "~/cluster_results/results_approx_0/streamcluster/m5out/stats.txt"
# file_data = processFile(file)
# all_benchmarks[nrow(all_benchmarks) + 1,] = file_data
# 
# file = "~/cluster_results/results_approx_0/swaptions/m5out/stats.txt"
# file_data = processFile(file)
# all_benchmarks[nrow(all_benchmarks) + 1,] = file_data
